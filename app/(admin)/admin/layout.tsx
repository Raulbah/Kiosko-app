...
export default async function AdminLayout({ children }: { children: React.ReactNode }) {
    ...
    return (
        <div className="min-h-screen bg-slate-50/50">
            ...
            {/* Sidebar Inteligente (Móvil + Desktop) */}
            <AdminSidebar 
                items={navItems} 
